        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center py-8">
              <div className="mb-8">
                <div className="w-24 h-24 mx-auto mb-6 border border-[var(--color-primary)] flex items-center justify-center rotate-45">
                  <Phone className="text-[var(--color-primary)] -rotate-45" size={36} />
                </div>
